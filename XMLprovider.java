...
public class XMLprovider implements Provider {
    ...
    //a method for reading an XML file and creating JAVA objects and storing them in memory
    public void readFile(List<Movie> movies) {
        ...
        try {
            ...
            NodeList nList = doc.getElementsByTagName("movie"); //movie list
            ...
            for (int i = 0; i < nList.getLength(); i++)
            {
                ...
                if (nNodeMovie.getNodeType() == Node.ELEMENT_NODE)
                {
                    ...
                    Element eElement = (Element) nNodeMovie;
